...
| `enablePurgeProtection` | bool | `False` |  | Optional. Provide 'true' to enable Key Vault's purge protection feature. |
...
| `secrets` | secureObject | `{object}` |  | Optional. All secrets to create |
