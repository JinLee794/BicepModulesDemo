...
$inputObject = @{
 ...
 TemplateFile      = "$home\BicepModulesDemo\arm\Microsoft.KeyVault\vault\deploy.bicep"
}
...
$inputObject = @(
    ...
    '--template-file',  "$home\BicepModulesDemo\arm\Microsoft.KeyVault\vault\deploy.bicep",
...
$inputObject = @{
 DeploymentName    = 'ExampleDeployment'
 ResourceGroupName = 'ExampleGroup'
 TemplateUri       = 'https://raw.githubusercontent.com/JinLee794/BicepModulesDemo/main/arm/Microsoft.KeyVault/vaults/deploy.bicep'
}
New-AzResourceGroupDeployment @inputObject
```
...
$inputObject = @(
    '--name',           'ExampleDeployment',
    '--resource-group', 'ExampleGroup',
    '--template-uri',   'https://raw.githubusercontent.com/JinLee794/BicepModulesDemo/main/arm/Microsoft.KeyVault/vaults/deploy.bicep',
    '--parameters',     'storageAccountType=Standard_GRS',
)
az deployment group create @inputObject
```
